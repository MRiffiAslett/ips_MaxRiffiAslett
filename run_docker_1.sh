...
OUTPUT_FILE="/app/results/results_112_112_3000_3000_100n_800d.txt"
...
<<<<<<< HEAD
  python3 $DATA_SCRIPT_PATH 28 28 --width 3000 --height 3000 --n_noise 100 --n_train 800 --n_test 1000 $DATA_DIR > \$DATA_GEN_LOG 2>&1
=======
  python3 $DATA_SCRIPT_PATH 112 112 --width 3000 --height 3000 --n_noise 100 --n_train 800 --n_test 1000 $DATA_DIR > \$DATA_GEN_LOG 2>&1
>>>>>>> new-branch
