#!/bin/bash
#SBATCH --job-name=run_all_docker_jobs_200
...
#SBATCH -e /home/mra23/ips_MaxRiffiAslett/output/run_all_docker_jobs_200_%j.err
#SBATCH -o /home/mra23/ips_MaxRiffiAslett/output/run_all_docker_jobs_200_%j.out
